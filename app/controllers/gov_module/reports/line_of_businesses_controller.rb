    ...
    class LineOfBusinessesController < ApplicationController
      def show
        ...
        if params[:from_date] && params[:to_date]
          ...
          @business_permits = @line_of_business.business_permits.not_cancelled.approved_at(from_date: from_date, to_date: to_date)
        else
          @business_permits = @line_of_business.business_permits.not_cancelled
        end
