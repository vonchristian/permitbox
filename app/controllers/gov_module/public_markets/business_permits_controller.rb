    ...
    class BusinessPermitsController < ApplicationController
      def index
        ...
        if params[:from_date] && params[:to_date]
          ...
          @business_permits = @public_market.business_permits.not_cancelled.approved_at(from_date: from_date, to_date: to_date)
        else
          @business_permits = @public_market.business_permits
        end
