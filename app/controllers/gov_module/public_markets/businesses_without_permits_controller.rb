  ...
  module PublicMarkets
    class BusinessesWithoutPermitsController < ApplicationController
      def index
        ...
        @businesses = @public_market.businesses.without_permits(from_date: @from_date, to_date: @to_date)
      ...
      def csv_body
        Enumerator.new do |yielder|
          ...
          @businesses.each do |business|
            ...
            business.current_location.try(:barangay_name),
            Tenancy.find_by(tenant: business, public_market: @public_market).tenancy_type,
